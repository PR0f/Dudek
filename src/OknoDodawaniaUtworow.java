...
public class OknoDodawaniaUtworow extends JFrame{
    ...
    public OknoDodawaniaUtworow(boolean nightLayout, test3 owner, int idPlyty, int idPiosenki, int idTworcy)
    {
        ...
        if(idPiosenki != 0) {
            try {
                ...
                ResultSet resultSet = statement.executeQuery("select * from piosenka where plyta=" + idPlyty+ " and id="+ idPiosenki);
                resultSet.next();
        ...
        signUpButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try
                {
                    ...
                    if(idPiosenki == 0) {
                        ps = connection.prepareStatement("insert into piosenka(id,nazwa, plyta) values(?,?,?)");
                        ps.setInt(1, 0);
                        ps.setString(2, textField1.getText());
                        ps.setInt(3, idPlyty);
                    }
                    else {
                        ps = connection.prepareStatement("update piosenka set nazwa=?, plyta=?  where id=?");
                        ps.setString(1, textField1.getText());
                        ps.setInt(2, idPlyty);
                        ps.setInt(3, idPiosenki);
                    }
